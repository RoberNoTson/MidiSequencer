...
private slots:
    ...
    void tickDisplay();
    void on_MIDI_Velocity_1_valueChanged(int);
    void on_MIDI_Velocity_2_valueChanged(int);
    void on_MIDI_Velocity_3_valueChanged(int);
    void on_MIDI_Velocity_4_valueChanged(int);
    void on_MIDI_Velocity_5_valueChanged(int);
    void on_MIDI_Velocity_6_valueChanged(int);
    void on_MIDI_Velocity_7_valueChanged(int);
    void on_MIDI_Velocity_8_valueChanged(int);
    void on_MIDI_Velocity_9_valueChanged(int);
    void on_MIDI_Velocity_10_valueChanged(int);
    void on_MIDI_Velocity_11_valueChanged(int);
    void on_MIDI_Velocity_12_valueChanged(int);
    void on_MIDI_Velocity_13_valueChanged(int);
    void on_MIDI_Velocity_14_valueChanged(int);
    void on_MIDI_Velocity_15_valueChanged(int);
    void on_MIDI_Velocity_16_valueChanged(int);
